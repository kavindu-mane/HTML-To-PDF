...
async function convertHTMLToPDF(
	...
	await page.setContent(htmlContent, { fullPage: true });
		...
		<div class="container">
			...
			<div class="left">
				...
				<div class="avatar-container">
					<img
						src="http://localhost:9000/avatar.jpeg"
						alt="avatar"
						class="avatar" />
				</div>
			...
			<div class="right">
				...
				<p class="description">
					...
					JavaScript , React , Bootstrap and Tailwind CSS. As well as I'm currently learning PHP and
					Express Js as backend technologies.These days I am reading for a degree in Bachelor of
					Computer Science and Technology degree program at Uva Wellassa University in Sri Lanka.
				</p>
					...
					<div class="content">
						...
						<div class="block">
							<div class="inner-block">
								...
								<p>
									Uva Wellassa University IEEE Open day 2023 official website. This website help to
									get an idea about IEEE and register event for undergraduates.
								</p>
							</div>
						</div>
						<!-- project 2 -->
						...
						<div class="block">
							<div class="inner-block">
								...
								<p>
									React Percentage Bar is more Customizable Circular and Linear percentage progress
									bar package for react apps
								</p>
							</div>
						</div>
						<!-- project 4 -->
						<div class="block">
							<div class="inner-block">
								...
								<p>
									...
									projects and many more. Generate markdown for your profile with just few clicks!
								</p>
							</div>
						</div>
						<!-- project 5 -->
